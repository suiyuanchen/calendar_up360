package com.kevincq.calendarlibrary.model;
...
public class MNCalendarVerticalConfig {
    ...
    //每个月标题的颜色
    private int mnCalendar_colorTitle = Color.parseColor("#000000");
    //星期栏的颜色
    private int mnCalendar_colorWeek = Color.parseColor("#58546A");
    //周末栏的颜色
    private int mnCalendar_colorWeekEnd = Color.parseColor("#F57223");
    //阳历的颜色
    private int mnCalendar_colorSolar = Color.parseColor("#000000");
    //阴历的颜色
    private int mnCalendar_colorLunar = Color.parseColor("#979797");
    //今天之前的日期的颜色
    private int mnCalendar_colorBeforeToday = Color.parseColor("#20000000");
    //开始结束的背景颜色
    private int mnCalendar_colorStartAndEndBg = Color.parseColor("#14BF5C");
    //区间中间的背景颜色
    private int mnCalendar_colorRangeBg = Color.parseColor("#1014BF5C");
    //区间文字的颜色
    private int mnCalendar_colorRangeText = Color.parseColor("#000000");
    //显示多少月(默认6个月)
    private int mnCalendar_countMonth = 4;
    ...
    public int getMnCalendar_colorWeekEnd() {
        return mnCalendar_colorWeekEnd;
    }

    public void setMnCalendar_colorWeekEnd(int mnCalendar_colorWeekEnd) {
        this.mnCalendar_colorWeekEnd = mnCalendar_colorWeekEnd;
    }
